...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///carros.db' # Configura a URI do banco de dados SQLite
...
app.register_blueprint(carro_routes) # Registra o blueprint das rotas de carro na aplicação Flask
